...
function scoreboard(inningScoreCB, inningCB, numInnings) {
  ...
  for(let i = 0; i < numInnings; i++){
    const currrentInning = inningScoreCB(inningCB);
    homeScore = homeScore * currrentInning.Home
    awayScore = awayScore * currrentInning.Away
    scoreByInnings.push(`inning ${i + 1}: Away ${currrentInning.Away} - Home ${currrentInning.Home}`);
  }
  if(homeScore === awayScore){
    scoreByInnings.push(`This game will require extra innings: Away ${currrentInning.Away} - Home ${currrentInning.Home}`);
  }else{
